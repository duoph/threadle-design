        ...
        <div className='flex w-full px-2 py-3'>
            ...
            <div className='w-full flex flex-col px-2'>
                <div className=' flex items-center justify-between'>
                    <p className='text-[15px] font-semibold overflow-hidden overflow-ellipsis'>{truncateText(product?.title || '', 50)}</p>
                ...
                <span className='flex text-[13px] items-center justify-start gap-2 font-normal'>Color :<span style={{ background: product?.color }} className={`relative cursor-pointer h-[13px] w-[13px] rounded-[50%] flex items-center justify-center shadow-lg`}>
